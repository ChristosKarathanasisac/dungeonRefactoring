...
final class CommandSets {
  ...
  private static CommandSet initializeDebugCommandSet() {
    CommandSet commandSet = CommandSet.emptyCommandSet();
    commandSet.addCommand(commandUnlockedAchievements());
    commandSet.addCommand(commandExploration());
    commandSet.addCommand(commandKills());
    commandSet.addCommand(commandCurrentLocation());
    commandSet.addCommand(commandGetMap());
    commandSet.addCommand(commandGetItems());
    commandSet.addCommand(commandCheckIfGameIsSaved());
    commandSet.addCommand(commandCreateCreature());
    commandSet.addCommand(commandGetCurrentTime());
    commandSet.addCommand(commandMakeTimePass());
    return commandSet;
  }
 ...
 * @return
 */
private static Command commandMakeTimePass() {
	return new Command("wait", "Makes time pass.") {
      @Override
      public void execute(@NotNull String[] arguments) {
 ...
 * @return
 */
private static Command commandGetCurrentTime() {
	return new Command("time", "Writes information about the current time.") {
      @Override
      public void execute(@NotNull String[] arguments) {
 ...
 * @return
 */
private static Command commandCreateCreature() {
	return new Command("spawn", "Spawns a creature.") {
      @Override
      public void execute(@NotNull String[] arguments) {
 ...
 * @return
 */
private static Command commandCheckIfGameIsSaved() {
	return new Command("saved", "Tests if the game is saved or not.") {
      @Override
      public void execute(@NotNull String[] arguments) {
 ...
 * @return
 */
private static Command commandGetItems() {
	return new Command("give", "Gives items to the character.") {
      @Override
      public void execute(@NotNull String[] arguments) {
        if (arguments.length != 0) {
          World world = Game.getGameState().getWorld();
 ...
 * @return
 */
private static Command commandGetMap() {
	return new Command("map", "Produces a map as complete as possible.") {
      @Override
      public void execute(@NotNull String[] arguments) {
 ...
 * @return
 */
private static Command commandCurrentLocation() {
	return new Command("location", "Writes information about the current location.") {
      @Override
      public void execute(@NotNull String[] arguments) {
 ...
 * @return
 */
private static Command commandKills() {
	return new Command("kills", "Writes statistics about your killings.") {
      @Override
      public void execute(@NotNull String[] arguments) {
 ...
 * @return
 */
private static Command commandExploration() {
	return new Command("exploration", "Writes statistics about your exploration.") {
      @Override
      public void execute(@NotNull String[] arguments) {
 ...
 * @return
 */
private static Command commandUnlockedAchievements() {
	return new Command("achievements", "Writes the achievements you have not yet unlocked.") {
      @Override
      public void execute(@NotNull String[] arguments) {
